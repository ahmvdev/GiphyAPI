...
function imageFetch(){
  ...
  let url = `https://api.giphy.com/v1/gifs/search?api_key=API_KEY_HERE&q=${input}`; //fetching the api here and passing the input value that is typed in the input field
fetch(url, {mode:'cors'})
